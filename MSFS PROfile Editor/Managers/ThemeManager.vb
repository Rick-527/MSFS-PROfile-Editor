...
Public Class ThemeManager
    ...
    Public Shared Sub ApplyModernTheme(frm As Form)
        ...
        Dim btnSecondary As Color = Color.FromArgb(48, 58, 68)  ' Dark Slate

        StyleControlCollection(
            frm.Controls,
            bgTextBox,
            textLight,
            btnPrimary,
    ...
    Private Shared Sub StyleControlCollection(
        ...
        For Each ctrl As Control In controls
                ...
                For Each item As ToolStripItem In toolStrip.Items
                    ...
                    If TypeOf item Is ToolStripStatusLabel Then
                        ...
                        Dim lbl As ToolStripStatusLabel =
                            DirectCast(item, ToolStripStatusLabel)
            ...
            ' Style child controls recursively
